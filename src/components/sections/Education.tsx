        ...
        <section className="layout-container min-h-screen flex flex-col justify-center pt-20">
            ...
            <div className="flex flex-col gap-6 mt-10">
                {educationData.map((education, index) => (
                    <div
                        key={index}
                        className="p-8 border border-white/10 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors flex flex-col gap-4"
                    >
                        <div className="flex flex-col lg:flex-row justify-between gap-2">
                            <h3 className="text-xl font-bold text-white uppercase tracking-tight">
                                {education.school}
                            </h3>
                            <span className="text-white/60 text-sm md:text-base font-medium lg:text-right text-nowrap">
                                {education.period}
                            </span>
                        </div>
