...
export const Projects = () => {
    return (
        <section id="Projects" className="layout-container min-h-screen flex flex-col justify-center pt-20">
            <div className="flex flex-col">
                <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tighter mb-8">
                    Technical Projects
                </h2>
                <p className="text-white/90 text-lg md:text-xl font-normal leading-relaxed max-w-6xl text-left mb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {projects.map((project) => (
                        <Card key={project.id} cardInfo={project} section="Projects" />
                    ))}
                </div>
            </div>
        </section>
